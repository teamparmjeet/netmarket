...
export default function Statement() {
  ...
  return (
    <div className="mx-auto lg:p-6 p-2 bg-white dark:bg-gray-700 shadow-lg rounded-lg text-gray-700 dark:text-white">
      <h2 className="text-2xl font-semibold mb-4 text-center">    My Regular Sales Comission</h2>
        ...
        <table className="w-full border-collapse border border-gray-300 rounded-lg overflow-hidden mt-4">
          <thead>
            <tr className="bg-gray-100 dark:bg-gray-600">
              ...
              <th className="border border-gray-300 px-1 text-sm py-2">Amount</th>
              <th className="border border-gray-300 px-1 text-sm py-2">Status</th>
            </tr>
          </thead>
          <tbody>
            {filteredData.map((entry, index) => (
              <tr key={index} className="text-center bg-white dark:bg-gray-800">
                ...
                <td className="border border-gray-300 px-4 py-2 text-green-500">Paid</td>
              </tr>
            ))}
          </tbody>
        </table>
