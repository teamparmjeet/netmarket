...
const Rimagecard = ({ title = "Default Title", description = "No description", viewmore = "#", image, sideimage }) => {
  ...
  return (
    <div className="relative flex flex-col md:flex-row-reverse items-center md:items-stretch bg-white shadow-xl rounded-3xl overflow-hidden hover:shadow-2xl transition-all duration-300">
      ...
      <div className="relative flex flex-col justify-center items-end p-10 md:p-14 w-full md:w-1/2 bg-gradient-to-br from-gray-50 to-white rounded-l-3xl">
        ...
        {/* Side Image */}
        {sideimage && (
          <div className="absolute top-[-10px] left-[-10px] lg:top-[-20px] lg:left-[20px] w-36 h-36 lg:w-48 lg:h-48 xl:w-64 xl:h-64 transform rotate-3 backdrop-blur-lg shadow-xl opacity-80 hover:opacity-100 transition-opacity duration-300">
            <Image
              src={sideimage}
              width={250}
              height={250}
