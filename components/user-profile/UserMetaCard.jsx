                            ...
                            <div className="h-[450px] overflow-y-auto px-2 pb-3">
                                <div>
                                    ...
                                    <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2 text-gray-800 dark:text-white/90">
                                        <div>
                                            <label className="block text-gray-700 dark:text-gray-300">Facebook</label>
                                            <input className="border  rounded w-full p-2" type="text" placeholder="https://www.facebook.com/PimjoHQ" />
                                        </div>
                                        <div>
                                            <label className="block text-gray-700 dark:text-gray-300">X.com</label>
                                            <input className="border  rounded w-full p-2" type="text" placeholder="https://x.com/PimjoHQ" />
                                        </div>
                                        <div>
                                            <label className="block text-gray-700 dark:text-gray-300">Linkedin</label>
                                            <input className="border  rounded w-full p-2" type="text" placeholder="https://www.linkedin.com/company/pimjo" />
                                        </div>
                                        <div>
                                            <label className="block text-gray-700 dark:text-gray-300">Instagram</label>
                                            <input className="border  rounded w-full p-2" type="text" placeholder="https://instagram.com/PimjoHQ" />
                                        </div>
                                    </div>
                                </div>
                                <div className="mt-7">
                                    ...
                                    <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2 text-gray-700 dark:text-gray-300">
                                        <div>
                                            <label className="block text-gray-700 dark:text-gray-300">First Name</label>
                                            <input className="border rounded w-full p-2" type="text" placeholder="Musharof" />
                                        </div>
                                        <div>
                                            <label className="block text-gray-700 dark:text-gray-300">Last Name</label>
                                            <input className="border rounded w-full p-2" type="text" placeholder="Chowdhury" />
                                        </div>
                                        <div>
                                            <label className="block text-gray-700 dark:text-gray-300">Post</label>
                                            <input className="border rounded w-full p-2" type="text" placeholder="Team Manager" />
                                        </div>
                                        <div>
